...
class AppColors {
  static const Color primary = Color(0xFFF83758); // Main accent / buttons / price
  ...
  static const Color textGrey = Color(0xFF676767); // Secondary text / description
  ...
  static const Color brokenImage = Color(0xFFE0E0E0); // Fallback for broken images
  static const Color dialogYes = Color(0xFFFFFFFF); // Logout dialog Yes button background
  static const Color dialogNo = Color(0xFF9E9E9E); // Logout dialog No button background
  ...
  static const Color iconSecondary = Color(0xFF9E9E9E); // Subtle icons (like search)
  static const Color textSecondary = Color(0xFF9E9E9E); // Placeholder / hint text
}
